...
def plot_validation_curve(logreg, X_train, Y_train):
    ...
    plt.title("Validation Curve with Logistic Regression", size = 15)
    ...
    plt.fill_between(param_range, test_scores_mean - test_scores_std, 
                     test_scores_mean + test_scores_std, alpha = 0.2, color = "g")
    plt.legend(loc = "best")
    plt.savefig('plot_validation_curve_rf_50_50')
    plt.show()
...
logreg = LogisticRegression(C = 1, solver= 'newton-cg', fit_intercept = True, 
                            class_weight = 'balanced')
